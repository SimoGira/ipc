...
void child(int id_number, int NPROC, int my_semaphores[], int fd1, int fd2){
    ...
    //####################################################
                                                       //#
    write(fd2, &id_number, sizeof(int));
    read(fd1, &childs_ready, sizeof(int));
                                                       //#
    //####################################################
    ...
    while(true)
    {
        ...
        read(fd1, &current_operation, sizeof(struct operation));
        ...
        write(fd2, &current_result, sizeof(struct result));
